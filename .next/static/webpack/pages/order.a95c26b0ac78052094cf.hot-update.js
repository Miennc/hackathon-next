  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    setNewCart(cart.map(function (item) {
      return {
        ...
        item_price: total,
        tax: 111111,
        items: JSON.stringify([item.name, item.price, item.quantity]),
        id_website: 4
      };
    }));
  }, [cart]);
